        ...
        <Paper className="flex w-full sm:w-auto min-h-full sm:min-h-auto md:w-full md:max-w-6xl rounded-0 sm:rounded-2xl sm:shadow overflow-hidden">
          <div className="w-full sm:w-auto py-32 px-16 sm:p-48 md:p-64 ltr:border-r-1 rtl:border-l-1">
            <div className="w-full max-w-320 sm:w-320 mx-auto sm:mx-0">
              <img className="w-auto h-full mx-auto max-h-64 mb-52" src="assets/images/logo/front-payment-go.png" alt="logo" />
            <form
                  name="loginForm"
                  noValidate
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between">
                  ...
                  <Link className="text-md font-medium no-underline" to="/pages/auth/forgot-password">
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="flex flex-col text-center justify-center items-center my-16 font-medium">
                <div>Don't have an account?</div>
                <Link className="no-underline hover:underline" to="/sign-up">
                  Register Now
                </Link>
              </div>

                <div className="flex items-center mt-32 space-x-12">
